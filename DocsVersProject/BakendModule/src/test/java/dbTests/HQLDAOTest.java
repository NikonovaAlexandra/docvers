...
public class HQLDAOTest {
    ...
    public void instantiate() throws Exception {
        ...
        sf = new AnnotationConfiguration().configure(new File("C:\\Documents and Settings\\Admin\\Рабочий стол\\docvers.git\\trunk\\DocsVersProject\\BakendModule\\src\\test\\java\\dbTests\\hibernate.xml")).buildSessionFactory();
    ...
    public void addDocumentTest() throws Exception {
        ...
        documentDAO = DAOFactory.getInstance().getDocumentDAO(session, DAOType.CRITERIA);
        Author a = new Author(2, "author1", "pass1");
