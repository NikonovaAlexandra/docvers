...
public class EntitiesDAOTest {
    ...
    public void instantiate() throws Exception {
        ...
        tester = new JdbcDatabaseTester("org.h2.Driver", "jdbc:h2:mem:tes", "root", "root");
        ...
        runner = AllScriptSInDirectoryRunner.getInstance("BakendModule\\src\\main\\resources\\scripts\\", false);
