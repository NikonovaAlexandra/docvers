...
//            sr.runScript(reader);
//            for (int i = 0; i < 5; ++i) {
//                ps = connection.prepareStatement(QueriesSQL.INSERT_INTO_AUTHOR);
...
//
//            for (int i = 0; i < 5; ++i) {
//                ps = connection.prepareStatement(QueriesSQL.INSERT_INTO_DOCUMENT);
...
//            }
//            for (int i = 0; i < 5; ++i) {
//                ps = connection.prepareStatement(QueriesSQL.INSERT_INTO_VERSION);
//                ps.setLong(1, 3);
//                ps.setLong(2, (5 / (i + 1)));
